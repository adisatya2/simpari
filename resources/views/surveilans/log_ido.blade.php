            ...
            <div class="card-body">
                ...
                <div id="accordion">
                    ...
                    <div class="card card-gray">
                        ...
                        <div id="collapsePreOperasi" class="collapse show" data-parent="#accordion"
                            aria-expanded="true">
                            <div class="card-body">
                                <div class="row">
                                    @if (isset($log->data_ruang_perawatan))
                                        ...
                                        <div class="col-lg-6 table-responsive">
                                            <table class="table table-sm">
                                                ...
                                                <tr>
                                                    <td class="align-top text-nowrap text-bold">Bundle Pre Operasi</td>
                                                    <td class="align-top">:</td>
                                                    <td>
                        ...
                        <div class="card-header">
                            <h4 class="card-title w-100">
                                <a class="d-block w-100" data-toggle="collapse" href="#collapseIntraOperasi">
                                    Bundle Intra Operasi
                                </a>
                            </h4>
                        </div>
                        <div id="collapseIntraOperasi" class="collapse show" data-parent="#accordion"
                            aria-expanded="true">
                            <div class="card-body">
                                <div class="row">
                                    @if (isset($log->ruang_operasi) && isset($log->nama_prosedur_operasi))
                                        ...
                                        <div class="col-lg-6 table-responsive">
                                            <table class="table table-sm">
                                                <tr>
                                                    <td class="align-top text-nowrap text-bold">Bundle Intra Operasi
                                                    </td>
                                                    <td class="align-top">:</td>
                                                    <td>
                                                        @foreach ($ido_bundle as $ido)
                    ...
                    <div class="card card-info">
                        ...
                        <div id="collapsePostOperasi" class="collapse show" data-parent="#accordion"
                            aria-expanded="true">
                            <div class="card-body">
                                <div class="row">
                                    @if (isset($log->status))
                                        ...
                                        <div class="col-lg-6 table-responsive">
                                            <table class="table table-sm">
                                                <tr>
                                                    <td class="align-top text-nowrap text-bold">Bundle Post Operasi
                                                    </td>
                                                    <td class="align-top">:</td>
                                                    <td>
                                                        @foreach ($ido_bundle as $ido)
